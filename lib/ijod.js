...
exports.getOnePars = function(targetIdr, cbDone, oneflag) {
  ...
  dal.query(sql, [], function(err, rows) {
    ...
    logger.debug("got ",ret.length," pars for ", hash);
    cbDone(null, ret);
  });
};
