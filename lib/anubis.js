...
exports.log = function (req, js) {
  ...
  if(Date.now() - req._started > 5000) logger.warn("slow response", Date.now() - req._started, req.url, req._authsome.app, JSON.stringify(js));
...
exports.reap = function (callback) {
  ...
  Object.keys(bundle).forEach(function (key) {
	...
	// shortcut out here, disable logging
