...
var MOBILE_GROUPS = {
  "android":{"base":"contact:id@service/android"},
  "ios":{"base":"contact:id@service/ios"}
}
...
Object.keys(MOBILE_GROUPS).forEach(function(path){ dMap.loadcustom('contact', path, MOBILE_MAP); });
