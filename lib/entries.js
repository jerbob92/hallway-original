...
var whitelist = ["b4ac1d88c60fff4223b4997aedcfa063",
  "68c71fe0193d65a43c01167624e59431",
  "36ec22e4655822c257d62afcf55c7b4e",
  "c54414630e7b2a49539bc321dd0f9815",
  "98166917475e1627df987bfc4a93ac0a",
  "1d4d5cdb6d8048bf44217593c2a33259",
  "08e2a56d345da847fd06ba26861f022d",
  "27463aedec5a5133deb812c3049409b4",
  "1eee17b5492ab7044e1355e7b64e85b0",
  "50bbafef788dab0ec0b8a8c466768483",
  "7eeadc5022037fc8fc69f0c7b7b2d434",
  "c31964a1dd3182d7b9debd50c4ff96d6",
  "2fee69309bf760294d79a803c8d9c9f8",
  "5d33b9578ddd63869b270fe7500876b4"];
...
exports.runBases = function(bases, options, cbEach, cbDone) {
  ...
  windower(bases, options, function(none) {
    ...
    async.forEach(bases, function(base, cb) {
      ...
      batch.sort(function(a, b) {
        return (options.sort == "asc") ? a.at - b.at : b.at - a.at;
      });
...
exports.options = function(query, path) {
  ...
  options.app = query._app; // from tokenz, hack
  options.q = query.q;
  options.sort = query.sort || "desc";
  if (query.participants) options.participants = query.participants.split(",");
  options.dedup = lutil.isTrue(query.dedup);
  if (query.pod) options.pod = parseInt(query.pod) || false;
...
exports.toString = function(entry, options) {
  ...
  if(options.app && whitelist.indexOf(options.app) == -1 && entry.idr && entry.idr.indexOf("self") == -1)
  {
    entry._warning = "This API has been deprecated, please contact support@singly.com";
    delete entry.data;
    delete entry.map;
    logger.warn("data disabled", options.app, entry.idr);
  }
