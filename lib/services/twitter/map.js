...
exports.tweet = {
    ...
    participants: function(data) {
      ...
      if(data.in_reply_to_user_id_str) ret[data.in_reply_to_user_id_str] = ret[data.in_reply_to_user_id_str] || {};
      if(data.entities && Array.isArray(data.entities.user_mentions)) data.entities.user_mentions.forEach(function(mention){
        if(mention.id_str) ret[mention.id_str] = ret[mention.id_str] || {};
      })
      var rtid = data.retweeted_status && data.retweeted_status.user && data.retweeted_status.user.id_str;
