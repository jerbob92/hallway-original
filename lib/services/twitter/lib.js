...
exports.getFFchunk = function(pi, arg, cbDone) {
  ...
  getOne(pi.tc, arg, function(err, js) {
    ...
    var users = [];
    // three passes to do 5k, drift back a bit to overlap more efficiently
    var ids = js.ids.slice(((arg.slice > 10) ? arg.slice-10 : arg.slice), 1700);
...
exports.getDirectMessages = function(pi, arg, cbDone) {
  arg.path = '/direct_messages.json';
  arg.token = pi.auth.token;
  getPage(pi.tc, arg, cbDone);
};
