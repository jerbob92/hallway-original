...
exports.contact = {
  ...
  oembed: function(data) {
    ...
    {
      // super messy data from fb, best heuristic so far is all employers w/o an end-date or one of 0000-00!
      var workat = "";
      data.work.forEach(function(work){
        if(!work.employer || !work.employer.name) return;
        if(work.end_date && work.end_date !== '0000-00') return;
        if(work.start_date && work.start_date === work.end_date) return; // just ignore suspicious data
