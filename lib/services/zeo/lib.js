...
var CALLER_DOMAIN = 'https://api.singly.com';
var API_KEY = require('../../../Config/apikeys.json').zeo.callerKey;
...
exports.apiCall = function(arg, cb) {
  if (!API_KEY) return cb(new Error('API caller key required for Zeo. Check Config/apikeys.json.example'));
