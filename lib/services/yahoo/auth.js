...
module.exports = {
  handler : function (callback, apiKeys, done, req, res) {
    ...
    var OA = new OAlib(
      'https://api.login.yahoo.com/oauth/v2/get_request_token?oauth_callback=' + callback,
    ...
    OA.getOAuthRequestToken({
      ...
      res.cookie('yahoo_client',
        serialize.stringify({token_secret:oauth_token_secret}),
        {path: '/', httpOnly: false}
      ); // stash the secret

      res.redirect('https://api.login.yahoo.com/oauth/v2/request_auth?oauth_callback=' +
