...
function createProfile(data, cbDone) {
...
function genGet(id, cbDone, app) {
  ...
  exports.loadProfile(id, function(err, profile) {
    ...
    return genGetLocal(profile, cbDone);
  });
}
...
exports.appGetSmart = function(id, app, cbDone){
  ...
  exports.loadProfile(id, function(err, profile) {
    if (err) return cbDone(err);
    if (!profile) {
      return createProfile(id, cbDone);
    }
...
exports.authGet = function(id, app, cbDone) {
  function cberr(err){
    logger.warn('authGet failed:', id, app, err && err.reason? err.reason:err);
    cbDone(err);
  }
...
exports.allSet = function(id, newAuth, newConfig, cbDone, appID) {
  ...
  exports.loadProfile(id, function(err, profile) {
    ...
    allSetLocal(id, newAuth, newConfig, cbDone);
  });
};
